...
| 全部 | 国产剧 | 海外剧 |
| ---- | ------ | ------ |
| 11   | 185    | 187    |`};async function r(n){let r=n.req.param(`tid`),i=!n.req.param(`embed`),a=await e({method:`get`,url:`https://api.bilibili.com/x/web-interface/newlist?ps=15&rid=${r}&_=${Date.now()}`,headers:{Referer:`https://www.bilibili.com/`}}),o=a.data.data.archives,s=`未知`;return o&&o[0]&&o[0].tname&&(s=o[0].tname),{title:`bilibili ${s}分区`,link:`https://www.bilibili.com`,description:`bilibili ${s}分区`,item:o&&o.map(e=>({title:e.title,description:t.renderUGCDescription(i,e.pic,e.desc,e.aid,void 0,e.bvid),pubDate:new Date(e.pubdate*1e3).toUTCString(),link:e.pubdate>t.bvidTime&&e.bvid?`https://www.bilibili.com/video/${e.bvid}`:`https://www.bilibili.com/video/av${e.aid}`,author:e.owner.name}))}}export{n as route};
//# sourceMappingURL=partion-DFbSij5A.js.map