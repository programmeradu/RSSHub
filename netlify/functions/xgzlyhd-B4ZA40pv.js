import{__dirname as e,init_esm_shims as t}from"./esm-shims-Dqvxr0BZ.js";import"./config-Dl8a1sIg.js";import"./logger-CWOoofbD.js";import"./dist-IvUHtNe1.js";import"./helpers-DzX-lcQO.js";import{art as n}from"./render-CxhTJIsl.js";import{parseDate as r}from"./parse-date-Bgabdhlb.js";import"./ofetch-Bzt0BXUH.js";import{got_default as i}from"./got-CdvI2yKX.js";import a from"node:path";import{load as o}from"cheerio";t();const s=`https://xgzlyhd.samr.gov.cn`,c=new URL(`gjjly/message/getMessageList`,s).href,l=new URL(`gjjly/message/getDataList`,s).href,u=new URL(`gjjly/index`,s).href,d={category:`1`,department:`2`},f=async e=>{let{data:t}=await i.post(l,{json:{type:d[e]}});return t.data},p=async(e,t)=>{let n=await f(e),r=n.filter(e=>e.name===t||e.code===t);if(r.length>0)return r.pop()},m={path:`/samr/xgzlyhd/:category?/:department?`,categories:[`government`],example:`/gov/samr/xgzlyhd`,parameters:{category:`留言类型，见下表，默认为全部`,department:`回复部门，见下表，默认为全部`},features:{requireConfig:!1,requirePuppeteer:!1,antiCrawler:!1,supportBT:!1,supportPodcast:!1,supportScihub:!1},radar:[{source:[`xgzlyhd.samr.gov.cn/gjjly/index`]}],name:`留言咨询`,maintainers:[`nczitzk`],handler:h,url:`xgzlyhd.samr.gov.cn/gjjly/index`,description:`#### 留言类型
...
| 离退办                       | 6bf265ffd1c94fa4a3f1687b03fa908b |`};async function h(t){let{category:l,department:d}=t.req.param(),f=t.req.query(`limit`)?Number.parseInt(t.req.query(`limit`),10):10,m,h;l&&(m=await p(`category`,l)),d&&(h=await p(`department`,d));let{data:g}=await i.post(c,{json:{clyj:``,curPage:`1`,endTime:``,fzsj:h?.code??``,lybt:void 0,lylx:m?.code??``,lynr:``,startTime:``,zj:``}}),_=g.data.data.slice(0,f).map(t=>({title:t.lybt,link:`${u}#${t.zj}`,description:n(a.join(e,`templates/description-81186473.art`),{item:t}),author:`${t.lyr} ⇄ ${t.fzsjCn}`,category:[t.fzsjCn],guid:`${u}#${t.zj}`,pubDate:r(t.pubtime)})),{data:v}=await i(u),y=o(v),b=`国家市场监督管理总局`,x=y(`title`).text(),S=[m?m.name:void 0,h?h.name:void 0].filter(Boolean).join(` - `),C=new URL(y(`link[rel="icon"]`).prop(`href`),s).href;return{item:_,title:`${b}${x}${S?` - ${S}`:``}`,link:u,description:y(`meta[property="og:description"]`).prop(`content`),language:`zh`,image:new URL(`gjjly/${y(`div.fd-logo img`).prop(`src`)}`,s).href,icon:C,logo:C,subtitle:S,author:b,allowEmpty:!0}}export{m as route};
//# sourceMappingURL=xgzlyhd-B4ZA40pv.js.map