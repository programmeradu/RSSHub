import"./esm-shims-Dqvxr0BZ.js";import"./config-Dl8a1sIg.js";import"./logger-CWOoofbD.js";import"./dist-IvUHtNe1.js";import"./helpers-DzX-lcQO.js";import"./cache-kimkMTWJ.js";import{parseDate as e}from"./parse-date-Bgabdhlb.js";import"./ofetch-Bzt0BXUH.js";import"./got-CdvI2yKX.js";import"./timezone-BrNu6iXe.js";import{rss_parser_default as t}from"./rss-parser-1vyhErsD.js";import{categories as n,getInfo as r,processItems as i,rootRSSUrl as a,rootUrl as o,title as s}from"./util-Dess27yo.js";const c={path:`/cid/:id?`,name:`更多分类`,parameters:{id:`分类，见下表，留空为直播`},example:`/mydrivers/cid/2`,maintainers:[`nczitzk`],handler:l,url:`m.mydrivers.com/`,radar:[{source:[`m.mydrivers.com/`],target:`/zhibo`}],description:`::: details 更多分类
...
:::`};async function l(c){let l=c.req.param(`id`),u=c.req.query(`limit`)?Number.parseInt(c.req.query(`limit`),10):100,d=l?`?cid=${l}`:``,f=new URL(l?`newsclass.aspx${d}`:``,o).href,p=new URL(`rss.aspx${d}`,a).href,m=await t.parseURL(p),h=m.items.slice(0,u).map(t=>({title:t.title,link:t.link,description:t.content,author:t.creator,category:t.categories,guid:t.guid.match(/\/(\d+)\.htm/)[1],pubDate:e(t.isoDate)}));return l&&(h=await i(h)),{...await r(f),item:h,title:`${s} - ${m.title.split(/_/).pop()||n.zhibo}`}}export{c as route};
//# sourceMappingURL=cid-p_6Q0VE3.js.map